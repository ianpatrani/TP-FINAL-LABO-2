...
/// CELL LIB///
/// CELL LIB///
/*stCell * loadListFromFile(stCell * userList) ///levanta el archivo de stPlaylist y trae CADA canci�n al usuario de CADA registro stPlaylist.
{                                           ///recordar que el struct stPlaylist tiene 1 idSong y 1 idUser para relacionarlas.
                                                ///eso es lo que pide el enunciado.
                                                    ///PERO PERO PERO por qu� no cargar la lista de canciones desde los idSong que almacena c/ user?
    FILE * fileUser;
